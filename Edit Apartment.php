...
<body>
  ...
  <div id="portal">
        ...
        <div>
           ...
           $query4="update apartment set apartmentname='apname',location='$loc',price='$number',houses='$houses',type='$type',photo1='$photo1',photo2='$photo2',photo3='$photo3'";
		...
		<form method="POST" id="addform" >
           <div id="top"><h4>Add Appartment Form</h4></div>
			   ...
			   <label>Type</label><select name="type" required>
                                    <option><?php echo$rowedit['']?></option>>
