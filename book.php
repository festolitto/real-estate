<html>
  ...
  <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
    ...
    //             $query3="select * from apartment where apartmentid=$apid";
			 ...
			 if($vacancies<1){
            	echo'<div id="full"><p>'.$apname. ' is Fully booked Do you Want to be on the waiting list?</p>
            	            <form method="POST">
				  ...
				  echo'<div id="success">You have successfully been allocated a room in '.$apname.' Apartment <a href="viewhouses.php">Done</a>';?>
				      ...
				      <div id="receipt" style="background:white;width:40%;height:;">
                       ...
                       <button onclick="printContent('receipt')">PRINT RECEIPT</button>
				      	...
				      	<?php
                       $qreceipt="select * from orders o join tenant t on(t.id=o.customerid) join apartment ap on(o.apartmentid=ap.apartmentid) where customerid='$cust_id' and orderid=(select max(orderid) from orders where customerid='$cust_id') and commitment is not null";
