  ...
  <div id="portal">
        <div id="portalnav">
            <div class="topnav" id="myTopnav">
                ...
                <div id="active"><a href="#" >Suspended Apartments</a></div>
         ...
         <?php
            ...
            $query="update apartment set apstatus='active' where apartmentid='$apartmentid'";
            $ressus=mysqli_query($conn,$query);
            
            if($ressus){
              echo'<div id="success">You have successfully activated '.$apartmentname.'</div>';

            }
            else{
              echo'<div id="fail">Failed to activate</div>';

            }

           }
          
           $query1="select ap.apartmentid as apid,ap.apartmentname as apname,ap.location as location,ap.houses as capacity,ap.houses-ap.occupied as vacancies,concat(l.firstname,' ',l.lastname) as landlordname,l.phone as phone,l.username as email from apartment ap join landlord l on(ap.landlord=l.id) where ap.apstatus='suspended'";
           $result1=mysqli_query($conn,$query1);
           $rowcheck1=mysqli_num_rows($result1);
           if($rowcheck1>0){
                echo'<table class="table border" id="ltable"><tr id="header"><th colspan="9"><h2>Suspended Apartments</h2></th></tr><tr><th>APARTMENTID</th><th>APARTMENTENT NAME</th><th>LOCATION</th><th>LANDLORD NAME</th><th>PHONE</th><th>EMAIL</th><th>CAPACITY</th><th>VACANCIES</th><th>ACTION</th></tr>';
             while($row1=mysqli_fetch_array($result1)){
              echo'<tr>
                      ...
                      <td><form method="POST">
                           ...
                           <input id="suspendbtn"type="submit" name="activate" value="Activate">
                           </form>
                      </td>
            ...
            echo'<div id="info">You currently have no Suspended apartments</div>';
           }
        ?>
