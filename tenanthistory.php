...
<div class="topnav" id="myTopnav">
  ...
  <div id="active"><a href="#">History</a></div>
...
<div class="content">
	<?php
	$query="select * from orders o join tenant t on(o.customerid=t.id) join apartment ap on(ap.apartmentid=o.apartmentid) where o.customerid='$custid' and o.status in('checkedout','timedout')";
	$res=mysqli_query($conn,$query);
    $rowcheck=mysqli_num_rows($res);

    if($rowcheck>0){
    	 echo'<table class="table border"><tr><th colspan="9" id="header">My History</th></tr>
    	             <tr><th>ORDER ID</th><th>ID</th><th>APARMENT NAME</th><th>TYPE</th><th>LOCATION</th><th>BOOKING DATE</th><th>REPORTING DATE</th><th>AMOUNT PAID</th><th>STATUS</th></tr>
	...
	echo'</table>';
		...
		echo'<div id="info">No booking history at the moment</div>';
	}
	?>
</div>
</body>
