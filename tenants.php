  ...
  <div id="portal">
        <div id="portalnav">
            <div class="topnav" id="myTopnav">
                ...
                <div id="active"><a href="tenants.php" >My Tenants</a></div>
        ...
        <form method="POST" class="selectapform">
         ...
         <?php
            ...
            $oid=$_POST['oid'];
            $query2="update orders set status='checkedout',checkoutdate='$now' where orderid='$oid'";
            ...
            if($res2){
              echo'<div id="success">Checked Out Successfully</div>';
            }
            else{
              echo'<div id="fail">Check Out Failed</div>';
            }
           }
           if(isset($_POST['select'])){
            $apname=$_POST['apname'];

           $query1="select o.orderid as orderid, concat(t.firstname,' ',t.lastname) as fullname,t.phone as phone,ap.apartmentname apname,o.bookingdate as bookingdate,o.checkindate as checkindate from orders o join tenant t on(o.customerid=t.id) join apartment ap on(o.apartmentid=ap.apartmentid) join landlord l on(ap.landlord=l.id) where ap.landlord=$landlord and o.status='checkedin' and ap.apartmentname='$apname'";
           $result1=mysqli_query($conn,$query1);
           $rowcheck1=mysqli_num_rows($result1);
           if($rowcheck1>0){
                echo'<table class="table border" id="ltable"><tr id="header"><th colspan="7"><h2>'.$apname.' Apartment Occupants</h2></th></tr><tr><th>ORDERID</th><th>TENANT NAME</th><th>TENANT PHONE</th><th>APARTMENT</th><th>BOOKING DATE</th><th>DATE REPORTED</th><th>ACTION</th></tr>';
             while($row1=mysqli_fetch_array($result1)){
              echo'<tr>
                      ...
                      <td>'.$row1["checkindate"].'</td>

                      <td><form method="POST"><input id="oid" type="text" name="oid" value="'.$row1['orderid'].'"><input id="checkedinbtn"type="submit" name="checkedout" value="Checked Out"></form></td>
            ...
            echo'<div id="info">You currently have no tenants for '.$apname.'</div>';
           }
       }
       else{
          $query1="select o.orderid as orderid, concat(t.firstname,' ',t.lastname) as fullname,t.phone as phone,ap.apartmentname apname,o.bookingdate as bookingdate,o.checkindate as checkindate from orders o join tenant t on(o.customerid=t.id) join apartment ap on(o.apartmentid=ap.apartmentid) join landlord l on(ap.landlord=l.id) where ap.landlord=$landlord and o.status='checkedin' and ap.apartmentname='$apname'";
